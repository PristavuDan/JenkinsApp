...
class QaPage(tk.Frame):
    ...
    def call_build_jenkins(self):
        ...
        main.build_using_qa(ticket_number, feeds_branch=feeds_branch,
                            ...
                            containers_branch=containers_branch, preflight_branch=preflight_branch,
                            firstbooted=first_booted)
